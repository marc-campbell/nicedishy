          ...
          <div className="col-5">
            <div className="card" style={{width: "100%"}}>
              <div className="card-body">
                ...
                <a className="btn btn-outline-secondary" href="https://github.com/marc-campbell/nicedishy-macos/releases/download/v0.4.9/NiceDishy.dmg"><i className="bi bi-cloud-download"></i> Download</a>
                {' '}
                ...
                <br /><br /><strong>Current Version:</strong> 0.4.9
              </div>
            </div>
            <div className="card" style={{width: "100%"}}>
              <div className="card-body">
